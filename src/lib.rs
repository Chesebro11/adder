...
// $ cargo test -- --test-threads=1 <---- changes how tests are run, able to just run one at a ytime instead of all at once?
// $ cargo test -- --show-output

// Shwoing Function Output

fn prints_and_returns_10(a: i32) -> i32 {
    println!("I got hte value {}", a);
    10
}
